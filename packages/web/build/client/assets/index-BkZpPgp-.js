import { r as O, g as S } from "./chunk-EF7DTUVF-BBWwU0kE.js";
var d = { exports: {} },
	n = {}; /**
 * @license React
	...
	return (
		...
		(n.preinit = (e, r) => {
			if (typeof e == "string" && r && typeof r.as == "string") {
				var t = r.as,
					c = s(t, r.crossOrigin),
					y = typeof r.integrity == "string" ? r.integrity : void 0,
					o = typeof r.fetchPriority == "string" ? r.fetchPriority : void 0;
				t === "style"
					? i.d.S(e, typeof r.precedence == "string" ? r.precedence : void 0, {
							crossOrigin: c,
							integrity: y,
							fetchPriority: o,
						})
		...
		(n.requestFormReset = (e) => {
			i.d.r(e);
		}),
		(n.unstable_batchedUpdates = (e, r) => e(r)),
		(n.useFormState = (e, r, t) => f.H.useFormState(e, r, t)),
