		...
		"properties": {
			...
			"heroImage": {
				...
				"properties": {
					"mediaType": {
						"type": "string",
						"description": "The MIME type of the uploaded image (e.g., image/jpeg, image/png)"
					},
					"url": {
						"type": "string",
...
const PRODUCT = {
	id: 'product',
	description: 'product page with title, description, price, currency, features, specifications, and images',
	schema:{
		"$schema": "http://json-schema.org/draft-07/schema#",
		"type": "object",
		"properties": {
