...
test.describe('Bluesky OAuth Flow - Comprehensive', () => {
  ...
  test.describe('UI Elements', () => {
    test('should display all OAuth UI elements correctly', async ({ page }) => {
      ...
      // Check main elements
      await expect(page.getByText('Sign in with your social account')).toBeVisible();
      ...
      const blueskyButton = page.getByRole('button', { name: 'Continue with Bluesky' });
  ...
  test.describe('OAuth Flow', () => {
    ...
    test('should handle OAuth callback with custom user data', async ({ page }) => {
