...
const ContentTypeEditorPage = lazy(
	() => import("@/pages/editor/ContentTypeEditorPage"),
);
const ContentTypeSelectPage = lazy(
	() => import("@/pages/editor/ContentTypeSelectPage"),
);
const EntryEditorPage = lazy(() => import("@/pages/editor/EntryEditorPage"));

function AppContent() {
	const { openSpacesDrawer, isSpacesDrawerOpen, closeSpacesDrawer } =
		useSpacesDrawer();
	...
	return (
		<div>
			...
			<SpacesDrawer open={isSpacesDrawerOpen} onClose={closeSpacesDrawer} />
